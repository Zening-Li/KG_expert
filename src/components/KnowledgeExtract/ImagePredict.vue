...
export default {
  ...
  methods: {
    ...
    modelTest() {
      this.loadingRes = true;
      this.$http
        .post("http://39.102.71.123:23352/pic/pic_detect_classification_all", {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    chooseTable() {
      if(this.fileIndex != "") {
        ...
        this.$http
          .post("http://39.102.71.123:23352/pic/pic_detect_classification_results_1", fd, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
    ...
    handleShow1(row) {
      ...
      this.$http
        .post("http://39.102.71.123:23352/pic/pic_detect_classification_results_2", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
