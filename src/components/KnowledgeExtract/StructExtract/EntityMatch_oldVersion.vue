<template>
  <el-container>
    ...
    <el-main v-show="graphFlag">
      <!--顶部-->
      <div class="header">
        <i class="el-icon-back" @click="function() {graphFlag=false;ontologyFlag=false;}"></i>
...
export default {
  ...
  methods: {
    loadPastFlag(){
      ...
      //清空标记
      this.$http.post("http://39.102.71.123:23352/pic/loadMarkData")
        .then(res => {
        console.log(res)
          //清空上次
          this.pastSumMap={};
    ...
    chooseTable() {
      ...
      this.loadingRes = true;
      this.$http
        .post("http://39.102.71.123:23352/pic/view_merge_data", fd, {
          headers: {
            "Content-Type": "multipart/form-data"
          }
        })
